...
<style>
    ...
    .sb{
        ...
        /* QUAN TRỌNG: không để auto cả sb, vì phần user sẽ bị đẩy ra ngoài */
        overflow: hidden;
    }
    ...
    /* User luôn nằm trong sidebar, không bị cắt */
    .sb-userwrap{
        flex: 0 0 auto;
        padding-top: 12px;
        padding-bottom: 12px;

        /* giữ nó luôn hiển thị */
        position: sticky;
        bottom: 0;

        background: #0f172a; /* trùng nền sidebar để không “hở” */
    }
</style>
<%
    ...
    if (obj != null && obj instanceof model.User) {
        ...
        if (userName == null || userName.trim().isEmpty()) userName = u.getEmail();
    }
