    ...
    <div class="hms-user">
      ...
      <button class="hms-avatarBtn" type="button" aria-haspopup="menu" aria-expanded="false">
        <span class="hms-avatar">
          <c:out value="${sessionScope.userInitials != null ? sessionScope.userInitials : ''}"/>
        </span>
...
<script defer src="${pageContext.request.contextPath}/assets/js/profile/header.js"></script>
