...
<head>
    ...
    <style>
        body { background: #f5f0e8; font-family: system-ui, -apple-system, sans-serif; }
        .hms-main { margin-left: 260px; width: calc(100% - 260px); padding: 30px; min-height: 100vh; }
        .card-custom { background: #fff; border: 1px solid #eef2f7; border-radius: 18px; box-shadow: 0 10px 30px rgba(15, 23, 42, .06); }
        .detail-label { font-size: 12px; color: #64748b; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 4px; }
        .detail-val { font-size: 1.1rem; font-weight: 700; color: #1e293b; margin-bottom: 20px;}
    </style>
</head>
<body>
<div class="d-flex">
