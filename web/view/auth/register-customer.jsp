...
<%-- Thêm thư viện JSTL Core để sử dụng thẻ c:if --%>
...
<head>
    ...
    <%-- Thêm FontAwesome để hiển thị icon cho chuyên nghiệp --%>
...
<body>
    ...
    <div class="form-side">
        <div class="container">
            ...
            <%-- 1. Hiển thị thông báo LỖI từ Servlet (Màu đỏ) --%>
            ...
            <%-- 2. Hiển thị thông báo GỬI LẠI MÃ KÍCH HOẠT (Màu xanh dương - Đúng yêu cầu của bạn) --%>
            ...
            <%-- 3. Hiển thị thông báo THÀNH CÔNG (Nếu dùng successMessage) --%>
            <c:if test="${not empty successMessage}">
                <div style="color: #52c41a; background: #f6ffed; border: 1px solid #b7eb8f; padding: 12px; border-radius: 4px; margin-bottom: 15px; text-align: center; font-size: 13px;">
                    ...
                    <br>
                    <a href="${pageContext.request.contextPath}/view/auth/login.jsp" style="color: #52c41a; font-weight: bold; text-decoration: underline;">Sign In Now</a>
                </div>
            </c:if>
            ...
            <div class="footer-links" style="margin-top: 25px; text-align: center; font-size: 13px; color: #888;">
                ALREADY HAVE AN ACCOUNT? <a href="${pageContext.request.contextPath}/view/auth/login.jsp" style="color: #b89664; text-decoration: none; font-weight: bold;">SIGN IN</a>
            </div>
        </div>
    </div>
