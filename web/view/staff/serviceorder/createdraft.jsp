                ...
                <div class="so-step">
                    ...
                    <div class="so-grid2">
                        <div>
                            ...
                            <input id="roomNo" class="so-input" placeholder="e.g., 201"/>
                            <div id="ctxErr" style="margin-top:6px;color:#d33;font-size:13px;"></div>
                        </div>

                        <div>
                            <div class="so-label">Booking ID *</div>
                            <input id="bookingId" class="so-input" placeholder="Auto..." readonly/>
                        </div>
                    </div>
                </div>
