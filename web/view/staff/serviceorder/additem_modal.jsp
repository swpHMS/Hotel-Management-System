...
<style>
    *, *::before, *::after {
    ...
    .aim-select:focus, .aim-input:focus {
        border-color: #818cf8;
    ...
    .aim-add-btn:hover {
        background: #4338ca;
        box-shadow: 0 5px 16px rgba(79,70,229,.38);
        ...
        <div class="aim-head">
            <div>
                ...
                <div class="aim-pills">
                    ...
                    <span class="aim-pill">Order ID-${selected.serviceOrderId}</span>
                </div>
            </div>
...
<script>
    ...
    let qty = 1;
    if (currentType !== 3) { // không phải CLEANING
    ...
    newItems.push({ serviceId, name, price, qty, type: currentType });
    }
    ...
    document.getElementById('newTotal').innerText = '0';
    return;
    }
