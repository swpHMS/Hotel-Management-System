  ...
  <div class="app-shell">
    ...
    <div class="hms-main">
      ...
      <main class="hms-page">
        ...
        <c:set var="activePct" value="${totalCount == 0 ? 0 : (activeCount * 100 / totalCount)}" />
          ...
          <div class="status-body">
            <div class="donut-wrap">
              ...
              <div class="donut-center">
                <div class="donut-big">${activePct}%</div>
            ...
            <div class="status-metrics">
              ...
              <div class="status-note">
                System health is optimal. <b>${activePct}%</b> users are currently active.
              </div>
            </div>
          </div>
        </section>
