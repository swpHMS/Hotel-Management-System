...
<body class="admin-shell">
  ...
  <%-- Nếu bạn có sidebar/topbar giống Staff thì include vào đây.
      Không có thì vẫn chạy được, chỉ thiếu sidebar. --%>
          ...
          <tbody>
            <c:forEach items="${customers}" var="c">
              <tr>
                ...
                <td class="text-right">
                  <a class="link" href="${pageContext.request.contextPath}/admin/customer-detail?id=${c.customerId}">
                    View Detail
                  </a>
                  ...
                  <c:choose>
                    <c:when test="${c.userId != null}">
                      <span class="sep">|</span>
                      <a class="link" href="${pageContext.request.contextPath}/admin/customer-status?id=${c.customerId}">
                        Change Status
                      </a>
                    </c:when>
                    <c:otherwise>
