...
<head>
  ...
  <!-- Nếu bạn đã dùng app.css cho admin thì giữ -->
  ...
  <style>
    ...
    .btnx-outline:hover{background:#f8fafc}
    .btnx-primary{
      background:var(--primary);
      color:#fff;
      box-shadow: 0 10px 22px rgba(79,70,229,.18);
    }
    .btnx-primary:hover{background:var(--primary2)}
    .btnx:disabled, .btnx.disabled{opacity:.5; cursor:not-allowed}
    ...
    .dot{width:5px;height:5px;border-radius:999px;background:#cbd5e1;display:inline-block}
    ...
    .badge-green{background:#e9fbef;color:#137a3a}
    .badge-red{background:#ffe9e9;color:#a11a1a}
