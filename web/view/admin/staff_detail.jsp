    ...
    <head>
        ...
        <style>
            ...
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .pill.inactive { background: var(--cream-dark); color: var(--ink-light); }
            .pill.inactive::before { background: var(--ink-faint); }
        ...
        <div class="app-shell">
            ...
            <div class="hms-main">
                <main class="hms-page">
                    ...
                    <a class="back-link" href="${pageContext.request.contextPath}/admin/staff">← Staff List</a>
                    ...
                    <div class="hms-page__top">
                        ...
                        <div class="top-actions">
                            <a class="btn btn-outline"
                               href="${pageContext.request.contextPath}/admin/staff/edit-profile?id=${staff.userId}">
                                Edit Profile
                            </a>
                    ...
                    <div class="detail-card">
                        ...
                        <div class="card-header">
                            <div>
                                <div class="card-header__name">${staff.fullName}</div>
                                <div class="card-header__meta">
                                    ${staff.roleName}&ensp;·&ensp;
                                    <c:choose>
                                        <c:when test="${staff.staffId == 0}">—</c:when>
                                        <c:otherwise>ID #${staff.staffId}</c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="detail-grid">
                            ...
                            <div class="detail-col">
                                <div class="section-label">
                                    <div class="section-label__line"></div>
                                    <div class="section-label__text">Contact &amp; Identity</div>
                                </div>
                                ...
                                <div class="detail-item">
                                    ...
                                    <div class="detail-v email">${staff.email}</div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer">
                            ...
                            <span class="card-footer__note">Staff Record</span>
                        </div>
