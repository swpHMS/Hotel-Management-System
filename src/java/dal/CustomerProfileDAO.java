...
public class CustomerProfileDAO extends DBContext {
    ...
    // ✅ Update các field cho customer dựa trên user_id
    public boolean updateCustomerProfileByUserId(int userId,
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            if (gender == null) ps.setNull(2, java.sql.Types.INTEGER);
            else ps.setInt(2, gender);

            if (dateOfBirth == null) ps.setNull(3, java.sql.Types.DATE);
            else ps.setDate(3, dateOfBirth);
