...
public class AdminTemplateDAO {
    ...
    public boolean existsByCode(String code) {
        String sql = "SELECT 1 FROM dbo.templates WHERE UPPER(code) = UPPER(?)";
        try (Connection con = new DBContext().getConnection();
             PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    public boolean existsByCodeExceptId(String code, int templateId) {
        String sql = "SELECT 1 FROM dbo.templates WHERE UPPER(code) = UPPER(?) AND template_id <> ?";
        try (Connection con = new DBContext().getConnection();
             PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    public int insert(EmailTemplate t) {
        String sql = """
            INSERT INTO dbo.templates (code, subject, content, is_active)
            VALUES (?, ?, ?, ?)
        """;
    ...
    public boolean renameTemplate(int templateId, String newCode) {
        String sql = "UPDATE dbo.templates SET code = ? WHERE template_id = ?";
        try (Connection con = new DBContext().getConnection();
             PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    public boolean delete(int templateId) {
        String sql = "DELETE FROM dbo.templates WHERE template_id = ?";
        try (Connection con = new DBContext().getConnection();
             PreparedStatement ps = con.prepareStatement(sql)) {
