...
@WebServlet(name = "CustomerCurrentBookingsPageServlet", urlPatterns = {"/customer/bookings/current"})
public class CustomerCurrentBookingsPageServlet extends HttpServlet {
