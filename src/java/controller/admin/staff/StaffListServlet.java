...
public class StaffListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int totalUsers = dao.countStaff(roleId, status, keyword);
            ...
            // 3) list (WITH FILTER + PAGING+Seach)
            List<UserProfile> users = dao.getStaffList(roleId, status, keyword, page, pageSize);
